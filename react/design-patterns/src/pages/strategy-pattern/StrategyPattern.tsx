...
function StrategyPattern() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex flex-col items-center justify-center gap-4 p-4">
      <div className='flex flex-col items-left gap-4'>
        <BackButton color="gray-100" />
        <div className="bg-gray-800 rounded-xl shadow-2xl p-8 min-w-[400px] border border-gray-700">
